...
export default function TournamentBracketPage() {
  ...
  if (loading) {
    return <div className="app-shell flex min-h-screen items-center justify-center text-gray-500">Loading bracket…</div>;
  }
    ...
    <div className="app-shell">
      <div className="page-container page-container--wide space-y-6">
        <PageHeader
          ...
          description={bracketStarted ? 'Bracket stage management' : 'Bracket has not started yet'}
          actions={<Link href="/tournaments/active" className="button button-secondary">← Back</Link>}
        />

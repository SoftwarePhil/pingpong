    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Link href="/tournaments/new" className="group bg-white hover:bg-gray-50 rounded-xl p-6 border-2 border-gray-200 hover:border-indigo-300 shadow-sm hover:shadow-md transition-all duration-200">
            <div className="text-3xl mb-3">➕</div>
            <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-indigo-600 transition-colors">New Tournament</h3>
            <p className="text-gray-500 text-sm">Set up round robin, bracket format, and best-of</p>
          </Link>
        </div>
